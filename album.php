...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['delete_album'])) {
        ...
        if ($_POST['action'] == 'addalbum' || $_POST['action'] == 'update_album') {
            ...
            $image_path = isset($_POST['existing_image']) ? validate($_POST['existing_image']) : 'assets/albums/noimg.png';
...
<head>
    ...
    <style>
        body {
            ...
            background-image: url('assets/styling/UI/login_background.jpg');
    ...
    <div class="album-form">
        <form id="album" method="POST" action="album.php" enctype="multipart/form-data">
            <table class="form-table">
                ...
                <input type="hidden" name="existing_image" value="<?php echo $isUpdatingAlbum ? $albumData['image_path'] : 'assets/albums//noimg.png'; ?>">
                <tr>
                    <td colspan="2">
